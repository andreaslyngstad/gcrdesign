  ...
  module Acts #:nodoc:
    module NestedSet #:nodoc:
      ...
      module InstanceMethods
        ...
        # Returns true if this is a descendant of the passed in node. Also returns true if this is the passed in node. 
        def descendant_of?(node) 
          node[left_col_name] <= self[left_col_name] && node[right_col_name] >= self[right_col_name] 
        end 
